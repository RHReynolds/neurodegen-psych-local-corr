...
- The number of AD, BIP, LBD, MDD, PD and SCZ SNPs across LD blocks (Figure \@ref(fig:loci-per-block)) and chromosomes (Figure \@ref(fig:loci-per-chr)) was not equally distributed. However, across most chromosomes, $\geq$ neurodegenerative or neuropsychiatric traits had overlapping genome-wide significant SNPs (Figure \@ref(fig:phenotypes-per-chr)). 

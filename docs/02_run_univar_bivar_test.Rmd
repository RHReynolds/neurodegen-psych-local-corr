...
1 (Figure \@ref(fig:)), which is consistent with a scenario where the genetic signal of those pairs of phenotypes in these LD blocks is completely shared.  
...
phen_count %>% 
  ...
  labs(
    ...
    fill = "Does r2 95% confidence interval include 1?"
  ) +

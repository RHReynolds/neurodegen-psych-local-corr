...
Given that bivariate local $r_{g}$ analyses revealed several loci where significant $r_{g}$'s were found between multiple trait pairs, we followed up with partial local $r_{g}$ analyses and multiple regression to obtain conditional genetic associations.  

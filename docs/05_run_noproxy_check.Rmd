...
ggsave(
  ...
  filename = "suppfig_2_proxy_analysis.png",
  device = "png", 
  width = 160, 
  height = 180, 
  dpi = 300, 
...
openxlsx::write.xlsx(
  xlsx,
  file = file.path(here::here("results", "99_manuscript_figures"), "SupplementaryTable4_lava_local_noproxy.xlsx"),
  row.names = FALSE,
